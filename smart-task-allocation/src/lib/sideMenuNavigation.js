export const sideMenuNavigation = {
  useradmin: {
    ...
    items: [
      ...
      { label: "Support", href: "/useradmin/support", icon: "content" },
    ],
  },
  manager: {
    label: "Manager",
    ...
    items: [
      ...
      { label: "Requests", href: "/manager/requests", icon: "tasks" },
      { label: "Agents", href: "/manager/agents", icon: "agents" },
      { label: "Support", href: "/manager/support", icon: "content" },
    ],
  },
  employee: {
    label: "Employee",
    ...
    items: [
      { label: "Assigned Work", href: "/employee/workspace", icon: "workspace" },
      { label: "Task Requests", href: "/employee/tasks", icon: "tasks" },
      ...
      { label: "Support", href: "/employee/support", icon: "content" },
    ],
  },
  platformadmin: {
    ...
    items: [
      ...
      { label: "Operations", href: "/platformadmin/operations", icon: "insights" },
    ],
  },
};
