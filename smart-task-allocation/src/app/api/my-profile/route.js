...
export async function GET(request) {
  try {
    ...
    // This endpoint is intentionally self-service only. Colleague cards use
    // role-scoped organization APIs and must never expose another profile by
    // manipulating a userId query parameter.
